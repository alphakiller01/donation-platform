...
<head>
  <title>Donator Edit Profile</title>
  ...
  <div class="container ">
    <div class="row" style="margin-top: 10px">
      <div class="col s12">
        ...
        <div id="editProfile" class="tabcontent" style="background-color:white; padding-bottom: 10px; padding: 10px">
          ...
          <form>
            ...
            <div class="center-align">
              ...
              <div class="col s6 input-field" style="margin-bottom: 30px;">
            ...
            <div class="input-field col s12">
             <div style="margin-bottom:">
              ...
              <i class="material-icons prefix">phone</i>
                ...
                <div class="col s12">
                 <!--  <h5 style="font-weight: bold ;margin-bottom:0px; margin-top: 30px">About Me</h5> -->
                  
                  </div>

                  <div class="input-field col s12">
                    <textarea id="textarea1" class="materialize-textarea"></textarea>
                    <label for="textarea1" style="margin-left: 10px">About Me</label>
                  </div>
        ...
        <div id="changePassword" class="tabcontent" style="background-color: white; padding: 30px">
          <form>
